...
class SimpleMusicManager {
    ...
    playStoryMusic(musicPath) {
        ...
        this.currentAudio.play().catch(e => console.log('Không thể phát nhạc:', e));
    }
...
// Tạo instance
const musicManager = new SimpleMusicManager();
...
class ChoiceGameManager {
    ...
    async startStory(storyId) {
        ...
        try {
            ...
            // Phát nhạc của story
            if (story.music) {
                musicManager.playStoryMusic(story.music);
            }
...
// Tắt nhạc khi thoát app/đóng trang
