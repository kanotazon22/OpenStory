// Game Logic Manager (No Emoji Logic)
class ChoiceGameManager {
    ...
    // Tính tổng số scene để hiển thị progress
    calculateTotalScenes() {
        this.gameStats.totalScenes = Object.keys(this.currentStory.scenes).length;
...
renderChoicesWithAnimation(choices) {
    ...
    updateProgressBar() {
        ...
        const progress = (this.gameStats.currentSceneNumber / this.gameStats.totalScenes) * 100;
